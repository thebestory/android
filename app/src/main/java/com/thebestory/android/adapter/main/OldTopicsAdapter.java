...
public class OldTopicsAdapter extends RecyclerView.Adapter<OldTopicsAdapter.TopicViewHolder> {

    private Context context;
    private OnClickListener listener;
    private List<Topic> topics;

    public OldTopicsAdapter(Context context, ArrayList<Topic> loadedTopic, OnClickListener listener) {
